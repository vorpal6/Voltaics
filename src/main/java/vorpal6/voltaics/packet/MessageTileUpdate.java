...
public class MessageTileUpdate implements IMessage {
	...
	public MessageTileUpdate(NBTTagCompound tag){
		this.tag = tag;
	}
    ...
    public static class MessageHolder implements IMessageHandler<MessageTileUpdate,IMessage>
    {
    	@SideOnly(Side.CLIENT)
        @Override
        public IMessage onMessage(final MessageTileUpdate message, final MessageContext ctx) {
